...
const academics = [
  {
    ...
    year: "2020 - 2024",
    cpi: "7.72 (Till 6th Semester)",
  },
  {
    college: "R.N.S World School, Jhansi",
    qualification: "CBSE - XII",
    year: "2019",
    cpi: "9.5",
  },
  {
    college: "Cathedral College, Jhansi",
    qualification: "ICSE - X",
    year: "2017",
    cpi: "91 %",
  },
];
        ...
        <div className="flex flex-col lg:flex-row ">
          ...
          >
            ...
            <h3 className="h3 max-w-[455px] mb-16">
              This is my current Educational Qualification.
            </h3>
          </motion.div>
          {/* academics */}
          <motion.div
                ...
                return (
                  ...
                  >
                    <div className="max-w-[476px]">
                      ...
                      <div className="my-2">CPI : {cpi}</div>
                    </div>
                  </div>
                );
              })}
